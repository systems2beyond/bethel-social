                                                    ...
                                                    if (verseLink) {
                                                        ...
                                                        if (ref) {
                                                            ...
                                                            if (match) {
                                                                ...
                                                                console.log("Opening Bible (New Tab Force)", { book, chapter, startVerse, endVerse });
                                                                openBible({
                                                                    book,
                                                                    chapter,
                                                                    verse: startVerse,
                                                                ...
                                                                console.log("Regex Failed, opening generic");
                                                                openBible();
                                                                onClose();
                                                            }
                                                        }
                                                    } else {
                                                        console.log("No .verse-link class found on ancestor");
                                                    }
                                                }}
                                            />
                                        </>
